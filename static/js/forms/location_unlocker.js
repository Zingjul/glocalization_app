...
document.addEventListener("change", () => {
  ...
  const typedInputs = {
    continent: document.getElementById("id_post_continent_input"),
    country: document.getElementById("id_post_country_input"),
    state: document.getElementById("id_post_state_input"),
  ...
  function isFilled(name) {
    ...
    const inputFilled = input && input.value.trim() !== "";

    console.log(`🧩 ${name} | dropdown: "${dropdown?.value}" | input: "${input?.value}"`);
    console.log(`→ Dropdown filled: ${dropdownFilled}, Input filled: ${inputFilled}`);
