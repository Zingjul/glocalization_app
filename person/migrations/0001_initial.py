    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('continent', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='specific_continent', to='custom_search.continent')),
                ('country', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='specific_country', to='custom_search.country')),
                ('state', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='specific_state', to='custom_search.state')),
                ('town', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='specific_town', to='custom_search.town')),
            ],
            options={
