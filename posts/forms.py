...
class PostForm(forms.ModelForm):
    ...
    class Meta:
        model = Post
        fields = ['category', 'description', 'author_phone_number', 'author_email']  # <-- Correct: NO IMAGE FIELDS HERE
        widgets = {
...
class CustomPostImageFormSet(forms.BaseInlineFormSet):
    def _construct_form(self, i, **kwargs):
        ...
        form.fields['DELETE'].widget = forms.HiddenInput()  # Hide the checkbox
        return form
