    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=posts.models.default_expiry)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to=settings.AUTH_USER_MODEL)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='posts.category')),
                ('post_continent', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_specific_continent', to='custom_search.continent')),
                ('post_country', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_specific_country', to='custom_search.country')),
                ('post_state', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_specific_state', to='custom_search.state')),
                ('post_town', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_specific_town', to='custom_search.town')),
            ],
            options={
                'ordering': ['-date'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_state', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_pending_requests', to='custom_search.state')),
